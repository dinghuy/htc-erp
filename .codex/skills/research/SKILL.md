...
### Vietnam Sector Source Priority
If the topic touches Vietnam, logistics, ports, shipping, construction, building materials, industrial production, factories, industrial parks, or infrastructure, read `C:\Users\dinghuy\.codex\skills\research\vn-sector-source-priority.md` and apply its source-priority rules.
...
## Source Priority
If the topic involves Vietnam logistics, ports, shipping, construction, building materials, industrial production, factories, industrial parks, or infrastructure:
1. Read C:\Users\dinghuy\.codex\skills\research\vn-sector-source-priority.md before searching
2. Apply the source priority and domain groups from that file
3. Use general press mainly for recent developments, interviews, and cross-checking
4. When sources disagree, prefer the more primary source and note the conflict in the explanation
