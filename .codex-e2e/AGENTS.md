...
This AGENTS.md scopes guidance to `.codex-e2e`. Parent AGENTS guidance still applies unless this file narrows it for this subtree.
...
### Files
- `click-audit.js`
- `debug-login-payload.js`
- `debug-login-typing.js`
- `debug-login.js`
- `enumerate-ui.js`
- `package-lock.json`
- `package.json`
